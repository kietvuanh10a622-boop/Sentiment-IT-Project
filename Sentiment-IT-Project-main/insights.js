        ...
        opportunityRiskMatrix = new Chart(ctx, {
          ...
          data: {
           ...
           options: {
             ...
             plugins: {
               legend: { labels: { color: '#707070', usePointStyle: true, boxWidth: 8 } },
               tooltip: { callbacks: { label: context => `Risk ${context.raw.x} · Opportunity ${context.raw.y}` } }
             },
             scales: {
               x: {
                 grid: { color: 'rgba(112, 112, 112, 0.16)' },
                 ticks: { color: '#707070' },
                 title: {
                   display: true,
                   text: 'Risk score',
